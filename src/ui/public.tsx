...
}> = ({ proposal, lead, items, paypalEnabled }) => {
  ...
  return (
    <Layout nav="public" title={`Proposal for ${lead?.name ?? "you"}`}>
      <main class="container-narrow page">
        ...
        <p class="center muted" style="margin-top:20px;font-size:.82rem">This proposal is valid for 30 days. Greenscape Pro · ROC licensed &amp; insured.</p>
      </main>
    </Layout>
  );
};
